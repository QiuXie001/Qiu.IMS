...
namespace Yue.Zero.EntityFramework
{
    ...
    /// </summary>
    public static class YueZeroDbModelBuilderExtensions
    {
        /// <summary>
        ...
        public static void ChangeYueTablePrefix<TTenant, TRole, TUser>(this DbModelBuilder modelBuilder, string prefix, string schemaName = null)
